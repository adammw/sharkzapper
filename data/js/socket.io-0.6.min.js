/** Socket.IO 0.6 - Built with build.js - Minified with Closure Compiler */
/**
* Socket.IO client
*
...
*/
this.io={version:"0.6",setPath:function(path){if(window.console&&console.error)console.error("io.setPath will be removed. Please set the variable WEB_SOCKET_SWF_LOCATION pointing to WebSocketMain.swf");this.path=/\/$/.test(path)?path:path+"/";WEB_SOCKET_SWF_LOCATION=path+"lib/vendor/web-socket-js/WebSocketMain.swf"}};if("jQuery"in this)jQuery.io=this.io;if(typeof window!="undefined")WEB_SOCKET_SWF_LOCATION="/socket.io/lib/vendor/web-socket-js/WebSocketMain.swf";
...
args)});return this};Flashsocket.check=function(){if(typeof WebSocket=="undefined"||!("__addTask"in WebSocket))return false;if(io.util.opera)return false;if("navigator"in window&&"plugins"in navigator&&navigator.plugins["Shockwave Flash"])return!!navigator.plugins["Shockwave Flash"].description;if("ActiveXObject"in window)try{return!!(new ActiveXObject("ShockwaveFlash.ShockwaveFlash")).GetVariable("$version")}catch(e){}return false};Flashsocket.xdomainCheck=function(){return true}})();
...
this._doc.body.appendChild(_iframeC);this._iframe=this._doc.createElement("iframe");_iframeC.appendChild(this._iframe);this._iframe.src=this._prepareUrl()+"/"+ +new Date};HTMLFile.prototype._=function(data,doc){this._onData(data);var script=doc.getElementsByTagName("script")[0];script.parentNode.removeChild(script)};HTMLFile.prototype._destroy=function(){if(this._iframe){this._iframe.src="about:blank";this._doc=null;CollectGarbage()}};HTMLFile.prototype.disconnect=function(){this._destroy();return io.Transport.XHR.prototype.disconnect.call(this)};
...
WebSocket.__initialize,false);else window.attachEvent("onload",WebSocket.__initialize)})();
