...
<body>
	<pre>
    sharkZapper is Copyright (C) 2010 <a href="http://adammw111.co.cc/">Adam Malcontenti-Wilson</a> &lt;<a href="mailto:adman.com@gmail.com">adman.com@gmail.com</a>&gt;
    You are hereby granted a licence to use the software as-is, and view the source code for educational purposes.
    You may not create deriviate versions of the software without written permission of the author.
    ...
    "Grooveshark" and Grooveshark Logos are trademarks of Escape Media Group.
	<hr />
	This is the <a href="http://code.google.com/chrome/extensions/background_pages.html">background script page</a>. If you are seeing this message you are using this extension incorrectly.
	Please go to the <a href="https://chrome.google.com/webstore/detail/dcaneijaapiiojfmgmdjeapgpapbjohb">Chrome Web Store</a> and click Install.
	<hr />
	This page should always be running in the background for sharkZapper to function correctly as all messages from the <a href="http://code.google.com/chrome/extensions/content_scripts.html">content script</a> and <a href="http://code.google.com/chrome/extensions/browserAction.html">browser action popup</a> are handled here
	</pre>
</body>
</html>
